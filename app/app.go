...
import (
	...
	appparams "github.com/fadeev/mercury/app/params"
	"github.com/fadeev/mercury/x/mercury"
	mercurykeeper "github.com/fadeev/mercury/x/mercury/keeper"
	mercurytypes "github.com/fadeev/mercury/x/mercury/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/mercuryd")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	mercuryKeeper mercurykeeper.Keeper
